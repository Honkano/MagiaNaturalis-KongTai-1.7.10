...
public class ScytheAuraHandler {
    ...
    private static final ResourceLocation DARK_CIRCLE = new ResourceLocation("magianaturalis:textures/misc/Dark.png");
    ...
    private boolean isHoldingScythe(EntityPlayer player) {
        ItemStack held = player.getCurrentEquippedItem();
        return held != null && held.getItem() == MNItems.herobrinesScythe;
    }
